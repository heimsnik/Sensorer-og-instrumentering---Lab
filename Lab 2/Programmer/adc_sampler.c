...
/* RPi PIN ASSIGNMENTS */
#define MISO1 17    // ADC 1 MISO (BCM 4 aka GPIO 4).
#define MISO2 16    //     2
#define MISO3 13    //     3
#define MISO4 12    //     4
#define MISO5 6    //     5

#define MOSI 18     // GPIO for SPI MOSI (BCM 10 aka GPIO 10 aka SPI_MOSI). MOSI not in use here due to single ch. ADCs, but must be defined anyway.
